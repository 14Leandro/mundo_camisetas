...
<body>
  ...
  <div class="container my-5">
    <div class="row g-4">
      ...
      <div class="col-md-6">
        ...
        <!-- Mostrar el stock -->
        <p><strong>Stock: </strong><?php echo intval($camiseta['stock']); ?></p>
        <hr>
  ...
  <!-- Script para manejar el envío del comentario en el futuro -->
  <script>
    // Ejemplo: Previene el envío del formulario y muestra un mensaje
